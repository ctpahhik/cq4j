...
public class BaseSqlParser extends Parser {
	...
	public static class OrOperandContext extends ConditionContext {
		...
		public OrOperandContext(ConditionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).enterOrOperand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).exitOrOperand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BaseSqlVisitor ) return ((BaseSqlVisitor<? extends T>)visitor).visitOrOperand(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AndOperandContext extends ConditionContext {
		public ConditionContext left;
		public ConditionContext right;
		public List<ConditionContext> condition() {
			return getRuleContexts(ConditionContext.class);
		...
		public AndOperandContext(ConditionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).enterAndOperand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).exitAndOperand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BaseSqlVisitor ) return ((BaseSqlVisitor<? extends T>)visitor).visitAndOperand(this);
			else return visitor.visitChildren(this);
		}
	}
		...
		try {
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new AndOperandContext(new ConditionContext(_parentctx, _parentState, _p));
						((AndOperandContext)_localctx).left = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_condition);
						setState(84);
						if (!(3 >= _localctx._p)) throw new FailedPredicateException(this, "3 >= $_p");
						setState(85); match(AND);
						setState(86); ((AndOperandContext)_localctx).right = condition(4);
						}
						break;

					case 2:
						{
						_localctx = new OrOperandContext(new ConditionContext(_parentctx, _parentState, _p));
						((OrOperandContext)_localctx).left = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_condition);
						setState(87);
						if (!(2 >= _localctx._p)) throw new FailedPredicateException(this, "2 >= $_p");
						setState(88); match(OR);
						setState(89); ((OrOperandContext)_localctx).right = condition(3);
						}
						break;
					}
					} 
	...
	public final PredicateContext predicate() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				setState(105);
				((ComparePredicateContext)_localctx).operand = _input.LT(1);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LT_EQ) | (1L << LT) | (1L << GT_EQ) | (1L << GT) | (1L << EQ) | (1L << NOT_EQ))) != 0)) ) {
					((ComparePredicateContext)_localctx).operand = (Token)_errHandler.recoverInline(this);
				}
				consume();
	...
	public static class UnaryOperandContext extends ExpressionContext {
		public Token operand;
		public ExpressionContext value;
		...
		public UnaryOperandContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).enterUnaryOperand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).exitUnaryOperand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BaseSqlVisitor ) return ((BaseSqlVisitor<? extends T>)visitor).visitUnaryOperand(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ArithmeticOperandContext extends ExpressionContext {
		public ExpressionContext left;
		public Token operand;
		public ExpressionContext right;
		public ExpressionContext expression(int i) {
		...
		public TerminalNode PLUS() { return getToken(BaseSqlParser.PLUS, 0); }
		public ArithmeticOperandContext(ExpressionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).enterArithmeticOperand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).exitArithmeticOperand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BaseSqlVisitor ) return ((BaseSqlVisitor<? extends T>)visitor).visitArithmeticOperand(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(138);
				((UnaryOperandContext)_localctx).operand = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==PLUS || _la==MINUS) ) {
					((UnaryOperandContext)_localctx).operand = (Token)_errHandler.recoverInline(this);
				}
				consume();
				setState(139); ((UnaryOperandContext)_localctx).value = expression(5);
				}
				break;
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case 1:
						{
						_localctx = new ArithmeticOperandContext(new ExpressionContext(_parentctx, _parentState, _p));
						((ArithmeticOperandContext)_localctx).left = _prevctx;
						pushNewRecursionContext(_localctx, _startState, RULE_expression);
						setState(148);
						if (!(4 >= _localctx._p)) throw new FailedPredicateException(this, "4 >= $_p");
						setState(149);
						((ArithmeticOperandContext)_localctx).operand = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==MULT || _la==DIV) ) {
							((ArithmeticOperandContext)_localctx).operand = (Token)_errHandler.recoverInline(this);
						}
						consume();
						setState(150); ((ArithmeticOperandContext)_localctx).right = expression(5);
						}
						break;
					...
					case 2:
						...
						consume();
						setState(153); ((ArithmeticOperandContext)_localctx).right = expression(4);
						}
						break;
					}
					} 
	...
	public static class SearchedCaseFunctionContext extends FunctionContext {
		public PredicateContext predicate;
		public List<PredicateContext> whenExpr = new ArrayList<PredicateContext>();
		public ExpressionContext expression;
		...
		public SearchedCaseFunctionContext(FunctionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).enterSearchedCaseFunction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).exitSearchedCaseFunction(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BaseSqlVisitor ) return ((BaseSqlVisitor<? extends T>)visitor).visitSearchedCaseFunction(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class CaseFunctionContext extends FunctionContext {
		...
		public List<TerminalNode> WHEN() { return getTokens(BaseSqlParser.WHEN); }
		public TerminalNode END() { return getToken(BaseSqlParser.END, 0); }
		public CaseFunctionContext(FunctionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).enterCaseFunction(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof BaseSqlListener ) ((BaseSqlListener)listener).exitCaseFunction(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BaseSqlVisitor ) return ((BaseSqlVisitor<? extends T>)visitor).visitCaseFunction(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			case 1:
				_localctx = new CaseFunctionContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(159); match(CASE);
				setState(160); ((CaseFunctionContext)_localctx).valueExpr = expression(0);
				setState(166); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
					...
					setState(162); ((CaseFunctionContext)_localctx).expression = expression(0);
					((CaseFunctionContext)_localctx).whenExpr.add(((CaseFunctionContext)_localctx).expression);
					setState(163); match(THEN);
					setState(164); ((CaseFunctionContext)_localctx).expression = expression(0);
					((CaseFunctionContext)_localctx).thenExpr.add(((CaseFunctionContext)_localctx).expression);
					}
					}
					setState(168); 
					_errHandler.sync(this);
				...
				if (_la==ELSE) {
					...
					setState(171); ((CaseFunctionContext)_localctx).elseExpr = expression(0);
					}
				}
			...
			case 2:
				_localctx = new SearchedCaseFunctionContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(176); match(CASE);
				setState(182); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
					{
					{
					setState(177); match(WHEN);
					setState(178); ((SearchedCaseFunctionContext)_localctx).predicate = predicate();
					((SearchedCaseFunctionContext)_localctx).whenExpr.add(((SearchedCaseFunctionContext)_localctx).predicate);
					setState(179); match(THEN);
					setState(180); ((SearchedCaseFunctionContext)_localctx).expression = expression(0);
					((SearchedCaseFunctionContext)_localctx).thenExpr.add(((SearchedCaseFunctionContext)_localctx).expression);
					}
					}
					setState(184); 
					_errHandler.sync(this);
				...
				if (_la==ELSE) {
					...
					setState(187); ((SearchedCaseFunctionContext)_localctx).elseExpr = expression(0);
					}
				}
	...
	public static final String _serializedATN =
		...
		"\n\r\f\r\16\r\u00a0\13\r\3\16\3\16\3\16\3\16\3\16\3\16\3\16\6\16\u00a9"+
		"\n\16\r\16\16\16\u00aa\3\16\3\16\5\16\u00af\n\16\3\16\3\16\3\16\3\16\3"+
		"\16\3\16\3\16\3\16\6\16\u00b9\n\16\r\16\16\16\u00ba\3\16\3\16\5\16\u00bf"+
		"\n\16\3\16\3\16\3\16\3\16\3\16\3\16\5\16\u00c7\n\16\3\16\7\16\u00ca\n"+
		"\16\f\16\16\16\u00cd\13\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16"+
		"\5\16\u00d8\n\16\3\16\3\16\5\16\u00dc\n\16\3\17\3\17\3\17\3\17\3\17\5"+
		"\17\u00e3\n\17\3\17\6\61\67=C\20\2\4\6\b\n\f\16\20\22\24\26\30\32\34\2"+
		"\5\3\2\22\27\3\2\3\4\3\2\5\6\u00fc\2\36\3\2\2\2\4\61\3\2\2\2\6\67\3\2"+
		"\2\2\b=\3\2\2\2\nC\3\2\2\2\fF\3\2\2\2\16I\3\2\2\2\20T\3\2\2\2\22t\3\2"+
		"\2\2\24\u0087\3\2\2\2\26\u0089\3\2\2\2\30\u0094\3\2\2\2\32\u00db\3\2\2"+
		"\2\34\u00e2\3\2\2\2\36\37\7\30\2\2\37 \5\4\3\2 !\7\31\2\2!$\5\6\4\2\""+
		"#\7\33\2\2#%\5\f\7\2$\"\3\2\2\2$%\3\2\2\2%(\3\2\2\2&\'\7\35\2\2\')\5\b"+
		"\5\2(&\3\2\2\2()\3\2\2\2),\3\2\2\2*+\7\34\2\2+-\5\n\6\2,*\3\2\2\2,-\3"+
