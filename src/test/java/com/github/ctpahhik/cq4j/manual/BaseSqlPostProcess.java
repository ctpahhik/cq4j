...
public class BaseSqlPostProcess {
    ...
    public static void main(String[] args) throws IOException {
        Lexer lexer = new BaseSqlLexer(new ANTLRInputStream(new StringReader("position_array(3 in \"[2,3,4]\")>0 or position_array(3 in \"[2,3,4]\" from 2)>0 and 3 between '' and 2 or -1+1*2>4 and a not in (2,3,5) or true and d is not null")));
        ...
        IOperation compiled = parser.simpleCondition().accept(visitor);
